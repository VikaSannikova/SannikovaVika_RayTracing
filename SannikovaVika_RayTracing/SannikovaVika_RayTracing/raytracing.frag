...
/*ФУНКЦИИ ДЛЯ ОБРАБОТКИ ЛУЧА*/
	...
	void initializeDefaultScene()
	{
		...
		/*СФЕРЫ*/
		spheres[0].Center = delta;//vec3(-1.0,-1.0,-2.0);
...
/*ФУНКЦИЯ пересекает луч со всеми примитивами сцены и возвращает ближайшее пересечение.*/
...
/*УПРАВЛЕНИЕ КАМЕРОЙ И УСТАНОВКА ЕЕ ПО УМОЛЧАНИЮ*/
...
/*ПЕРЕЧИСЛЕНИЕ МАТЕРИАЛОВ И УСТАНОВЛЕНИЕ ИСТОЧНИКА СВЕТА*/
